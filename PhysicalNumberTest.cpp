...
.CHECK_OK(x4 = PhysicalNumber(4, Unit::SEC))
.CHECK_OUTPUT((x5 += PhysicalNumber(4, Unit::SEC)), "4.066667[min]")
...
.CHECK_OUTPUT((x6 += PhysicalNumber(4, Unit::MIN)), "4.066667[hour]") 
.CHECK_OK((x6 = PhysicalNumber(4, Unit::HOUR)))
...
.CHECK_OK(x4 = PhysicalNumber(4, Unit::SEC))
.CHECK_OUTPUT((x5 -= PhysicalNumber(4, Unit::SEC)), "3.933333[min]")
.CHECK_OK((x5 = PhysicalNumber(4, Unit::MIN)))
...
.CHECK_OK((x6 = PhysicalNumber(4, Unit::HOUR)))
.CHECK_OUTPUT((x6 -= PhysicalNumber(4, Unit::MIN)), "3.933333[hour]") 
.CHECK_OK((x6 = PhysicalNumber(4, Unit::HOUR)))
...
.setname("Comparing operations on meters")
.CHECK_EQUAL(x1<x2,true)
.CHECK_EQUAL(x1<x3,true)
.CHECK_EQUAL(x1>x2,false)
.CHECK_EQUAL(x1>x3,false)
.CHECK_EQUAL(x2<x1,false)
.CHECK_EQUAL(x2<x3,true)
.CHECK_EQUAL(x2>x1,true)
.CHECK_EQUAL(x2>x3,false)
.CHECK_EQUAL(x3<x1,false)
.CHECK_EQUAL(x3<x2,false)
.CHECK_EQUAL(x3>x1,true)
.CHECK_EQUAL(x3>x2,true)

.setname("Comparing operations on time")
.CHECK_EQUAL(x4<x5,true)
.CHECK_EQUAL(x4<x6,true)
.CHECK_EQUAL(x4>x5,false)
.CHECK_EQUAL(x4>x6,false)
.CHECK_EQUAL(x5<x4,false)
.CHECK_EQUAL(x5<x6,true)
.CHECK_EQUAL(x5>x4,true)
.CHECK_EQUAL(x5>x6,false)
.CHECK_EQUAL(x6<x4,false)
.CHECK_EQUAL(x6<x5,false)
.CHECK_EQUAL(x6>x4,true)
.CHECK_EQUAL(x6>x5,true)

.setname("Comparing operations on mass")
.CHECK_EQUAL(x7<x8,true)
.CHECK_EQUAL(x7<x9,true)
.CHECK_EQUAL(x7>x8,false)
.CHECK_EQUAL(x7>x9,false)
.CHECK_EQUAL(x8<x7,false)
.CHECK_EQUAL(x8<x9,true)
.CHECK_EQUAL(x8>x7,true)
.CHECK_EQUAL(x8>x9,false)
.CHECK_EQUAL(x9<x7,false)
.CHECK_EQUAL(x9<x8,false)
.CHECK_EQUAL(x9>x7,true)
.CHECK_EQUAL(x9>x8,true)

.setname("Comparing invalid operations on meters")
// .CHECK_THROWS(x1<x4)
// .CHECK_THROWS(x1<x5)
// .CHECK_THROWS(x1>x6)
// .CHECK_THROWS(x1>x7)
